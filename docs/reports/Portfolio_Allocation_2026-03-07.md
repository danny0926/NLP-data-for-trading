...
| Consumer Cyclical | 14.71% | 3 |
| Communication Services | 9.71% | 2 |

**多樣性分數**: 0.8192 (1.0=完全分散, 0.0=集中)
...
### 評分模型 (Research-Aligned, RB-001~RB-006)

| 因子 | 權重 | 說明 | 研究依據 |
|------|------|------|----------|
| 信念廣度 | 25 | 交易該標的的議員人數 (3 人得滿分) | RB-001 |
| Buy 方向 | 15 | Buy +0.77% CAR_5d (Sale 不計正 alpha) | RB-004 |
| Buy 比例 | 5 | 純 Buy 標的加分 (Sale -3.21% 20d) | RB-004 |
| SQS 品質 | 5 | 降權: SQS conviction 與 alpha r=-0.50 | RB-006 |
| 收斂訊號 | 20 | 多位議員同方向交易加分 (提權) | RB-006 |
| 金額權重 | 15 | $15K-$50K 最強訊號 (提權) | RB-001 |
| 甜蜜點加分 | +5 | $15K-$50K 額外加分 (alpha+93%, Quant validation) | RB-001 |
| 院別加權 | 10 | Senate 20d +1.39% >> House -1.27% | RB-004 |
| 議員品質 | 5 | Top PIS 議員交易加分 | RB-005 |
...
- Buy-Only 策略 (RB-004): Sale-Only 標的已排除
