...
POLITICIAN_SOCIAL_TARGETS: List[Dict] = [
    ...
    },
    {
        ...
        "sector_focus": ["finance", "tech"],
        "note": "金融服務委員會，科技/金融關注",
    },
    {
        "name": "Shelley Moore Capito",
        "twitter": "@SenCapito",
        "committees": ["Appropriations", "Commerce"],
        "sector_focus": ["infrastructure", "energy"],
        "note": "撥款委員會，基建/能源關注",
    },
    {
        ...
        "note": "司法委員會，科技監管/醫療關注",
    },
    {
        "name": "Steve Cohen",
        "twitter": "@RepCohen",
        "committees": ["Judiciary", "Transportation"],
        "sector_focus": ["transportation", "finance"],
        "note": "司法/交通委員會成員",
    },
    {
        "name": "Bill Hagerty",
        "twitter": "@SenatorHagerty",
        "committees": ["Banking", "Foreign Relations"],
        "sector_focus": ["finance", "defense"],
        "note": "銀行委員會，前駐日大使",
    },
    {
